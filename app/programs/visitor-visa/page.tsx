...
export const metadata: Metadata = {
  ...
  description: "Visitor visa and super visa application support."
};

export default function VisitorVisaPage() {
  return (
    <>
      <PageHero eyebrow="Programs" title="Visitor Visa & Super Visa" copy="Temporary resident visa and super visa support for visitors and family members." />
        ...
        <div className="container-lux max-w-5xl">
          <div className="grid gap-6">
            <article className="rounded-lg border border-charcoal/10 bg-porcelain p-6 sm:p-8">
              ...
              <p className="mt-4 leading-8 text-charcoal/72">We prepare visitor visa (temporary resident visa) applications and super visa applications for parents and grandparents. We focus on demonstrating temporary intent, financial support and strong ties, while handling invitation letters and supporting documents.</p>
            </article>
            ...
            <article className="rounded-lg bg-charcoal p-6 text-white sm:p-8">
              ...
              <p className="mt-4 leading-8 text-white/76">Temporary entry authorization for short or extended visits; advice on extensions or change of status if circumstances change.</p>
              <div className="mt-8">
                <ButtonLink href="/consultation-booking" className="bg-gold text-charcoal hover:bg-white">Apply for Visitor Visa <ArrowRight size={18} /></ButtonLink>
              </div>
            </article>
          </div>
        </div>
