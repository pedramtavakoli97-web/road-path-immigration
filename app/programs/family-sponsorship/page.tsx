...
export const metadata: Metadata = {
  ...
  description: "Family sponsorship and permanent residence application support."
};
  ...
  return (
    <>
      <PageHero
        eyebrow="Programs"
        title="Family Sponsorship"
        copy="Sponsorship and permanent residence support for eligible family members."
      />
          ...
          <div className="grid gap-6">
            ...
            <article className="rounded-lg border border-charcoal/10 bg-white p-6 sm:p-8">
              ...
              <ul className="mt-4 grid gap-3 leading-8 text-charcoal/72">
                ...
                <li className="flex gap-3"><span className="mt-3 h-1.5 w-1.5 shrink-0 rounded-full bg-burgundy" />Advise on the appropriate sponsorship stream, required documents and timing.</li>
