...
const services = [
  {
    ...
    focus: ["ارزیابی مسیر مناسب دریافت مجوز کار", "تهیه و ارسال درخواست LMIA", "آماده‌سازی درخواست‌های مجوز کار و تمدید", "بررسی قراردادها و مدارک استخدامی"],
    outcome:
  ...
  },
  {
    ...
    outcome:
      "دریافت ویزای تحصیلی، مجوز کار پس از فارغ‌التحصیلی و برنامه‌ریزی برای مسیر اقامت دائم کانادا."
  },
  {
    title: "ویزای توریستی",
    ...
    focus: ["انتخاب گزینه مناسب بین TRV، eTA و سوپر ویزا", "تهیه دعوتنامه و مدارک مالی", "آماده‌سازی بیمه درمانی سوپر ویزا", "ارسال پرونده و پیگیری مکاتبات"],
    outcome:
  ...
  },
  {
    ...
    icon: FileBadge2,
    summary:
      "ما در زمینه تمدید یا تعویض کارت اقامت دائم، دریافت مدارک سفر، بررسی شرایط حفظ اقامت و اعتراض به تصمیمات اداره مهاجرت خدمات ارائه می‌دهیم.",
    ...
    outcome:
      "حفظ یا بازگرداندن وضعیت اقامت دائم، دریافت مدارک سفر و آماده‌سازی دقیق پرونده‌های اعتراض مهاجرتی."
  }
];
